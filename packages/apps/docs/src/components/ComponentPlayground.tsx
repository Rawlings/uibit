...
import { CemManifest, CemMember } from '../types/docs';
...
export function ComponentPlayground({ tagName, manifest, Demo }: ComponentPlaygroundProps) {
  ...
  const configurableAttrs: CemMember[] = (declaration?.members ?? []).filter(

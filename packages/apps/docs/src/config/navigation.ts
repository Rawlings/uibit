...
export const TOOLING: NavigationItem[] = [
  {
    ...
    title: 'Codegen',
    to: '/tooling/codegen',
    category: 'Codegen & Wrappers',
  },
  {
    id: 'base-class',
    title: 'Base Class',
    to: '/tooling/base-class',
    category: 'Runtime',
  },
  {
    id: 'form-internals',
    title: 'Form Internals',
    to: '/tooling/form-internals',
    category: 'Runtime',
  },
  {
    id: 'cem-extended',
    title: 'CEM Extended',
    to: '/tooling/cem-extended',
    category: 'Manifest Tooling',
  },
  {
    id: 'cem-mcp',
...
export const CATEGORY_ORDER = ['Layout', 'Media', 'Text', 'Data', 'Forms'];

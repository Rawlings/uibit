    ...
    >
      <uibit-image-comparison mode="radial" progress={30} hover-reveal>
        <img
          ...
          alt="Vintage black and white car"
          style={{
            width: '100%',
            height: '100%',
            objectFit: 'cover',
...
const example: UsageExample = {
  ...
  description:
    'Triggers a circular magnification reveal that tracks the mouse movement without requiring dragging.',
  Demo: RadialDemo,
};

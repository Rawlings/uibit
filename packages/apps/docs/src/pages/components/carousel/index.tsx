...
function CarouselDemo() {
  return (
    <uibit-carousel loop>
      <img
        src="https://picsum.photos/seed/alps/900/560"
        alt="Alpine meadow at dawn"
        style={{
          width: '100%',
          height: '280px',
          objectFit: 'cover',
      ...
      />
      <img
        src="https://picsum.photos/seed/coastline/900/560"
      ...
      />
      <img
        src="https://picsum.photos/seed/kyoto/900/560"
        alt="Temple path in autumn forest"
        style={{
          width: '100%',
          height: '280px',
          objectFit: 'cover',
      ...
      />
      <img
        src="https://picsum.photos/seed/dunes/900/560"
  ...
  a11y: {
    ...
    keyboardNav: [
      ...
      { key: 'ArrowRight', description: 'Advance to the next slide.' },
      {
        key: 'Tab',
        description:
          'Navigate focus between the navigation buttons and indicator controls.',
      },
    ],
  },
};

...
const data: ComponentDocData = {
  ...
  demoCode: {
    html: `<uibit-particles count="80" speed="1" connect connect-distance="90" hover-effect="repel">
  <div>Content goes here</div>
</uibit-particles>`,
    react: `import '@uibit/particles';
...
function Demo() {
  ...
  a11y: {
    ...
    requirements: [
      ...
      'Ensure particle colors have sufficient contrast against foreground text, or reduce opacity via --uibit-particles-opacity.',
    ],
  },
  features: [

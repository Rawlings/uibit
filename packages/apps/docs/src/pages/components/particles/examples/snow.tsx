  ...
  return (
    ...
    >
      <uibit-particles
        ...
        style={
          {
            '--uibit-particles-color': '#ffffff #f3f4f6 #e5e7eb #9ca3af',
            '--uibit-particles-min-size': '0.05rem',
            '--uibit-particles-max-size': '0.25rem',
          } as any
        }
      >
        <div
...
const example: UsageExample = {
  title: 'Snowy Breeze',
  description:
    'Recreates falling snow using a dedicated snow physics mode and multi-toned greyscale color arrays.',
  Demo: SnowDemo,
};

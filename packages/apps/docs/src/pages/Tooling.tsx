...
const DESCRIPTIONS: Record<string, string> = {
  codegen: 'Generate React, Vue 3, Svelte 5, Angular, SolidJS, Astro, Preact, and Vanilla TS wrappers from a Custom Elements Manifest.',
  'base-class': 'Shared foundation, optimizations, event dispatch, and performance decorators for UIBit components.',
  'form-internals': 'Standardized wrapper around ElementInternals for form participation, CSS validation states, and constraint validation.',
  hmr: 'Swaps updated Custom Element classes and styles in-place without a page reload, preserving component state.',
  'cem-extended': 'Custom Elements Manifest generator plugin adding JSDoc method parameter/return details, custom states, and heritage.',
  'cem-mcp': 'Local Model Context Protocol (MCP) server exposing UIBit Custom Elements Manifest schemas to AI coding agents.',
  'cem-oxc': 'Ultra-fast, zero-dependency Custom Elements Manifest generator powered by OXC and Rust.',
  hoistlock: 'Zero-configuration, ultra-fast bundle hoisting prevention engine in Rust.',
};
    ...
    <div className="relative bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-200">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-xl mx-auto leading-relaxed">
          Every UIBit component is generated, validated, and shipped through this tooling. It's independent of the
          component library itself — drop any piece into your own custom element project.
        </p>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24">
        <div className="border-t border-gray-100 dark:border-gray-900 pt-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md">
            Want to see this tooling in action? Every component in the library is built with it.
          </p>
          <Link
            to="/components"

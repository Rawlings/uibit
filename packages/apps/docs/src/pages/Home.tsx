    ...
    <div className="relative bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-200 overflow-hidden">
      ...
      <section className="relative max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-xl mx-auto leading-relaxed mb-8">
          UIBit is two things: a curated library of high-performance, accessible
          components — and the codegen, manifest, and runtime tooling used to
          build, wrap, and maintain them. Use them together, or take either on
          its own.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
              Accessible, framework-agnostic web components built with Lit —
              layout, media, text, data, and form elements ready to drop into
              any stack.
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
              Codegen, Custom Elements Manifest tooling, HMR, and runtime
              primitives — the same tooling that builds this library, usable in
              your own custom element projects.
            </p>
          </Link>
        </div>
      </section>
              ...
              {[
                {
                  ...
                  description:
                    'Three-tier CSS token architecture. Override anything from global palette to per-component properties.',
                },
                {
                  to: '/foundations/localization',
                  label: 'Localization',
                  description:
                    'Ship in any language. Built-in @lit/localize support with automatic RTL layout handling.',
                },
                {
                  to: '/foundations/icons',
                  label: 'Icons',
                  description:
                    'Built-in Lucide icons. Override any icon or register your own with a single function call.',
                },
                {
                  to: '/foundations/frameworks',
                  label: 'Framework Integrations',
                  description:
                    'Auto-generated type wrappers for React, Vue, Svelte, Angular, Astro, and more.',
                },

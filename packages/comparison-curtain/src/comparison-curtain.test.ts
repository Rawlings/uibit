...
import './comparison-curtain';
import { ComparisonCurtain } from './comparison-curtain';

describe('ComparisonCurtain Component', () => {
  let element: ComparisonCurtain;

  beforeEach(async () => {
    element = document.createElement('uibit-comparison-curtain') as ComparisonCurtain;

 ...
 *
 * @cssprop [--uibit-effect-particles-color=#6b7280] - Space or comma-separated list of colors
 * @cssprop [--uibit-effect-particles-line-color=#e5e7eb] - Color of connecting lines
 * @cssprop [--uibit-effect-particles-opacity=1] - Opacity of the canvas overlay
 * @cssprop [--uibit-effect-particles-min-size=0.0625rem] - Minimum particle size
 * @cssprop [--uibit-effect-particles-max-size=0.1875rem] - Maximum particle size
 */
@customElement('uibit-effect-particles')
export class EffectParticles extends UIBitElement {
  ...
  private _parseColors(): string[] {
    const raw = this.getCssPropertyValue('--uibit-effect-particles-color') || '#6b7280';
  ...
  private _initParticles() {
    ...
    const minSize = this._parseSize('--uibit-effect-particles-min-size', 1);
    const maxSize = this._parseSize('--uibit-effect-particles-max-size', 3);
  ...
  private _updateAndDraw() {
    ...
    if (this._colorCheckTick % 30 === 0) {
      this._lineColor = this.getCssPropertyValue('--uibit-effect-particles-line-color') || '#e5e7eb';
      const colors = this._parseColors();
...
declare global {
  interface HTMLElementTagNameMap {
    'uibit-effect-particles': EffectParticles;
  }
}

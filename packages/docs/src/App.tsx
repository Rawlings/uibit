        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-6">
              <Link
                to="/styling"
                className="text-sm font-medium text-gray-600 dark:text-gray-350 hover:text-gray-950 dark:hover:text-white transition-colors"
              >
                Styling
              </Link>
              <Link
      ...
      <main className="flex-1">
        <Routes>
          ...
          <Route
            path="*"
            element={
              <div className="max-w-6xl mx-auto px-4 py-24 text-center bg-white dark:bg-gray-950">

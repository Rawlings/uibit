...
export default function StylingGuide() {
        ...
        <aside className="w-full md:w-64 shrink-0 border-b md:border-b-0 md:border-r border-gray-200 pb-6 md:pb-0 md:pr-6 md:sticky md:top-8 md:h-[calc(100vh-6rem)] md:overflow-y-auto">
          <div>
            ...
            <nav className="space-y-1 pr-2 mb-6">
              <Link
                to="/styling"
                className="block px-3 py-2 rounded-md text-sm font-semibold bg-gray-100 text-gray-950"
              >
                Styling & Theming
              </Link>
            </nav>
        ...
        <div className="flex-1 min-w-0">
          ...
          <nav className="mb-6">
            <p className="text-sm text-gray-600 flex items-center gap-2">
              ...
              <span className="text-gray-900 font-medium">Styling & Theming</span>
            </p>
          </nav>
          ...
          <section className="mb-12 border-t border-gray-100 pt-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Design Token Hierarchy</h2>
            <p className="text-sm text-gray-600 mb-6 leading-relaxed">
              We employ a three-tier token architecture:
            </p>
            <div className="space-y-4 mb-6">
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                <h3 className="font-semibold text-sm text-gray-900 mb-1">Tier 1: Global Palette</h3>
                <p className="text-xs text-gray-600">Base variables that define the brand's raw color scales (e.g. <code>--uibit-color-gray-100</code>). These map directly to Tailwind values.</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                <h3 className="font-semibold text-sm text-gray-900 mb-1">Tier 2: Semantic Tokens</h3>
                <p className="text-xs text-gray-600">Contextual variables shared across elements (e.g. <code>--uibit-border-color</code> or <code>--uibit-radius-lg</code>).</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                <h3 className="font-semibold text-sm text-gray-900 mb-1">Tier 3: Component Custom Properties</h3>
                <p className="text-xs text-gray-600">Highly specific properties per component (e.g. <code>--uibit-carousel-border-color</code>) that default back to semantic or palette tokens.</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12 border-t border-gray-100 pt-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Setting Up The Global Stylesheet</h2>
          ...
          {/* Font Inheritance */}
          <section className="mb-12 border-t border-gray-100 pt-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Font Inheritance</h2>
            <p className="text-sm text-gray-600 mb-4 leading-relaxed">
          ...
          {/* Examples */}
          <section className="mb-12 border-t border-gray-100 pt-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Customization Examples</h2>
            <div className="space-y-8">
              <div>
                <h3 className="text-base font-semibold text-gray-900 mb-2">1. Theme-wide Overrides</h3>
                <p className="text-sm text-gray-600 mb-3">Redefine global border colors and radii inside your application's root stylesheet:</p>
  ...
  --uibit-radius-lg: 0.125rem;    /* Boxy borders */
              ...
              <div>
                <h3 className="text-base font-semibold text-gray-900 mb-2">2. Dynamic Theme Classes</h3>
                <p className="text-sm text-gray-600 mb-3">Wrap components in selectors with custom styling scopes, enabling quick design variant toggling:</p>
                <pre className="code-block text-gray-100 p-4 overflow-x-auto text-sm leading-relaxed">
                  <code>{`.neo-brutalist {

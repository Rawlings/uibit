...
function CustomLensDemo() {
  return (
    <uibit-image-reveal style={{ '--uibit-image-reveal-lens-size': '18rem' } as React.CSSProperties}>
        <img
...
const customLens: UsageExample = {
  ...
  description: 'Control the lens diameter with the --uibit-image-reveal-lens-size CSS custom property for a larger reveal area.',
  Demo: CustomLensDemo,
};

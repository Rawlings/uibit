...
const data: ComponentDocData = {
  ...
  usages: [
    ...
    {
      title: 'Custom Options via Slots',
      description: 'Replace the default emoji set by nesting elements with value, icon, and label attributes.',
      code: `<uibit-sentiment-bar show-label>
  <div value="1" icon="angry" label="Not helpful"></div>
  <div value="2" icon="frown" label="Okay"></div>
  <div value="3" icon="meh" label="Helpful"></div>
  <div value="4" icon="smile" label="Very helpful"></div>

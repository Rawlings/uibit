  ...
  return (
    <div className="max-w-2xl bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6 shadow-sm">
      <uibit-text-read-timer show-icon>
        ...
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">The Role of Typography in Editorial Design</h2>
        <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed line-clamp-4">{articleText.trim()}</p>

  ...
  usages: [
    {
      ...
      code: `<uibit-read-timer show-icon>
  <article>
    <h1>Article Title</h1>
    ...
    {
      title: 'Custom Template and WPM',
      description: 'Adjust for technical audiences who read more slowly, or customize the label string.',
      code: `<uibit-read-timer wpm="180" template="{time} to read" show-icon>
  <div class="content">...</div>
</uibit-read-timer>`,
    },
    {
      title: 'Analytics Integration',
      code: `document.querySelector('uibit-read-timer').addEventListener('read-time-change', e => {
  analytics.track('article_read_time', {
    wordCount: e.detail.words,
    estimatedMinutes: e.detail.minutes,
  });
});`,
    },
  ],

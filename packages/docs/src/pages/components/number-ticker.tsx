  ...
  usages: [
    {
      ...
      code: `<uibit-number-ticker value="12800" prefix="$" locale="en-US" duration="1800"></uibit-number-ticker>
<uibit-number-ticker value="99.9" suffix="%" decimals="1" easing="ease-in-out"></uibit-number-ticker>`,
    },
    {
      title: 'React Integration',
      code: `import '@uibit/number-ticker';

function Stats() {
  return (
    <div className="stats-grid">
      <uibit-number-ticker value={12800} prefix="$" locale="en-US" duration={1800} />
      <uibit-number-ticker value={99.9} suffix="%" decimals={1} />
      <uibit-number-ticker value={4200} suffix="+" repeat />
    </div>
  );
}`,
    },
    {
      ...
      description: 'Chain animations or track completions using the ticker events.',
      code: `document.querySelector('uibit-number-ticker').addEventListener('ticker-end', () => {
  document.querySelector('.stat-label').classList.add('visible');
});`,
    },
  ],
  features: [

          ...
          <div className="relative border border-gray-300 rounded-lg overflow-hidden bg-white shadow-md">
            ...
            >
              <div className="flex flex-col items-center justify-center gap-2 text-center px-4">
                ...
                <p className="text-sm text-gray-500">Use code <span className="font-mono font-bold text-gray-800">LUCKY30</span> at checkout</p>
                <p className="text-xs text-gray-400 mt-1">Valid until midnight · One use per customer</p>
              </div>
            </uibit-scratch-reveal>
          </div>
